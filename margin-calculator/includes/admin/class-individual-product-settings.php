<?php 
  ...
  class Individual_Product_Settings{
        ...
        public static function init(){
            /**
             * Adding actions for the custom settings to add,save and sanitize
             */
        ...
        /**
         * adding the new variation settings on variation
         * 2 Settings 
         * custom_field_repeat {repeater}
         * custom_field_setup_cost{numberfield}
         */
      public static  function variation_settings_fields( $loop, $variation_data, $variation ) {
            $setup_cost=get_post_meta( $variation->ID,'custom_field_setup_cost',false);
        ...
        <div class="settings_repeat_wrap">
            ...
            <div class="quantity_wrapper"> 
                <label for="custom_field_setup_cost">Setup</label>
                <input type="number" name="custom_field_setup_cost" class="variations_setup_input_fields" value="<?php echo $setup_cost[0] ?>">
            </div>
                <?php
                ...
                <div class="single-product-repeater_field" id="single-product-repeater">
                    <div class="quantity_wrapper"> 
                        ...
                        <input type="number" name="custom_field_repeat[<?php echo $count ?>][quantity]" class="variations_quantity_input_fields" value="<?php echo $fields['quantity'] ?>">
                    </div>
                    <div class="price_wrapper">
                        <label for="custom_field_repeat">Price</label>
                        <input type="number" name="custom_field_repeat[<?php echo $count ?>][price]" class="variations_price_input_fields" value="<?php echo $fields['price'] ?>" >
                    </div>   
                    <div class="special_price_wrapper"> 
                        <label for="custom_field_repeat">Special Price</label>
                        <input type="number" name="custom_field_repeat[<?php echo $count ?>][special_price]" class="variations_special_price_input_fields" value="<?php echo $fields['special_price'] ?>">
                    </div>
                ...
                <div class="single-product-repeater_field" id="single-product-repeater">
                        <div class="quantity_wrapper"> 
                            <label for="custom_field_repeat">Quantity</label>
                            <input type="number" name="custom_field_repeat[0][quantity]" class="variations_quantity_input_fields" value="">
                        </div>
                        <div class="price_wrapper">
                            <label for="custom_field_repeat">Price</label>
                            <input type="number" name="custom_field_repeat[0][price]" class="variations_price_input_fields" value="" >
                        </div>   
                        <div class="special_price_wrapper"> 
                            <label for="custom_field_repeat">Special Price</label>
                            <input type="number" name="custom_field_repeat[0][special_price]" class="variations_special_price_input_fields" value="">
                        </div>
                        <div class="class_retrive">
                            <a href="javascript:void(0)" class="detail_productremove_row">
                                <i class="fa fa-close"></i>
        ...
        /**
         * Saving Settings 
         * custom_field_repeat{Multidimensional array}
         * custom_field_setup_cost[array]
         */
      public static  function save_variation_settings_fields( $variation_id, $loop ) { 
         $setup_cost=$_POST['custom_field_setup_cost'];
